...
void Config_Settings::set_variable(std::string& variable_name, std::string& variable_value_str, std::string& input_description_char, bool print_to_screen) {
  ...
  if (found == true) {
    ...
    switch(SettingName) {
      ...
      case SN::inital_propagation_step :
        inital_propagation_step_set(std::stoi(variable_value_str));
        inital_propagation_step_description_set(input_description_char);
        break;
...
void Config_Settings::print() {
    ...
    std::cout << "   inital_propagation_step: " << inital_propagation_step() << "   " << inital_propagation_step_description() << std::endl;
...
void Config_Settings::print(std::string path_) {
    ...
    if (config_log.is_open()) {
      ...
      config_log << "{inital_propagation_step} {" << inital_propagation_step() << "} {" << inital_propagation_step_description() << "}\n";
...
int Config_Settings::inital_propagation_step() { return inital_propagation_step_; }
void Config_Settings::inital_propagation_step_set(int value) { inital_propagation_step_ = value; }
std::string Config_Settings::inital_propagation_step_description() { return inital_propagation_step_description_; }
void Config_Settings::inital_propagation_step_description_set(std::string description) { inital_propagation_step_description_ = description; }
