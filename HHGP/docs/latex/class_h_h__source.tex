...
{\footnotesize\ttfamily Array\+X\+Xcd H\+H\+\_\+source\+::\+Get\+Source (\begin{DoxyParamCaption}\item[{int}]{file\+Number,  }\item[{\hyperlink{class_h_h_1_1_config___settings}{H\+H\+::\+Config\+\_\+\+Settings}}]{config,  }\item[{maths\+\_\+textbook}]{maths }\end{DoxyParamCaption})}
