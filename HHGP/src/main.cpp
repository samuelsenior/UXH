...
//std::cout << "Foo 0-1: " << rkr.n_r << prop.n_k << std::endl;
//std::cout << "Foo 0-2: " << w_active.rows() << std::endl;
//std::cout << "Foo 0: " << prop.A_w_r.real().rows() << std::endl;
...
//std::cout << A_w_r.rows() << ", " << A_w_r.cols() << std::endl;
//std::cout << A_w_r_tmp.rows() << ", " << A_w_r_tmp.cols() << std::endl;
//std::cout << prop.A_w_r.rows() << ", " << prop.A_w_r.cols() << std::endl;
...
//std::cout << "Foo6" << std::endl;
        ...
        //A_w_m_out = ArrayXXcd::Zero(prop.n_k, rkr.n_r);
        //for (int ii = 0; ii < prop.n_k; ii++)
        //    A_w_m_out.row(ii) = ht.forward(A_w_r_tmp.row(ii));
